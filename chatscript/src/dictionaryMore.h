...
#define RENAMED					QUERY_KIND		// _alpha name renames _number
...
#define WORDNET_ID				0x00008000		// a wordnet synset header node (MASTER w gloss ) only used when building a dictionary
#define TRACE_MACRO				WORDNET_ID		// turn on tracing for this function (only used when live running)
...
#define KINDS_OF_PHRASES ( CLAUSE | PHRASE | VERBAL | OMITTED_TIME_PREP | OMITTED_OF_PREP )
